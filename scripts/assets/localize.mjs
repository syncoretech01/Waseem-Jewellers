...
lines.push('## Videos', '', 'Each tier is encoded twice; a visit downloads one tier of one codec. AV1 where supported, H.264 fallback; verified in Chromium.', '', '| id | use | duration | 1280 h264 / av1 | 720 h264 / av1 | portrait h264 / av1 | poster |', '|---|---|---|---|---|---|---|');
