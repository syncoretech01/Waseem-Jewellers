...
| Chapter | What to do |
|---|---|
| Hero | Let the film run; LAHORE · SINCE 1952, the shop's name, one line, and the five departments as the first doors — nothing else competes with the jewellery. The header carries the authentic lockup (crest, ligature and the name on one line; WASEEM alone on a phone) and becomes the crest once the page has moved; the motion control is a quiet glyph. The concierge is the crest at the bottom right. |
