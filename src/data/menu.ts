...
export const MENU: MenuItem[] = [
  ...
  { id: 'collections', label: 'Collections', numeral: '04', kind: 'chapter', target: 'collections', media: { still: 'p04-hero', video: 'menu-ambient' }, line: 'Five worlds of Waseem.' },
  { id: 'bespoke', label: 'Bespoke', numeral: '05', kind: 'modal', target: 'bespoke', media: { still: 'p10-hero' }, line: 'An idea, a stone, a form.' },
  { id: 'house', label: 'Heritage', numeral: '06', kind: 'chapter', target: 'heritage', media: { still: 'heritage-facade' }, line: 'Lahore, since 1952.' },
];
