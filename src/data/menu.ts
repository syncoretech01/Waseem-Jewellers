...
export const MENU: MenuItem[] = [
  { id: 'gold', label: 'Gold', numeral: '01', kind: 'route', target: '/collections/bridal?edit=gold', media: { still: 'p05-hero' }, line: 'Kundan, polki and pleated gold.' },
  { id: 'diamond', label: 'Diamond', numeral: '02', kind: 'route', target: '/collections/bridal?edit=diamond', media: { still: 'p07-hero', video: 'diamond-studio' }, line: 'Pavé, cluster and uncut stones.' },
