...
/**
 * The five signature collection worlds of CH04. `imagery.hero` is always the middle
 * tile so the FLIP into /collections/bridal?world= lands on the same image.
 * Urdu is only present where the campaign title cards show it (Dewan).
 */
export const WORLDS: CollectionWorld[] = [
  {
    ...
    imagery: { column: ['p02-hero', 'p02-third', 'w-rukh-3'], hero: 'p02-third' },
  ...
  },
  {
    ...
    imagery: { column: ['p05-second', 'p05-hero', 'w-aks-3'], hero: 'p05-hero' },
  ...
  },
  {
    ...
    imagery: { column: ['p06-hero', 'p06-second', 'w-rang-3'], hero: 'p06-second' },
  ...
  },
  {
    ...
    imagery: { column: ['w-dewan-1', 'p04-hero', 'w-dewan-3'], hero: 'p04-hero' },
  ...
  },
  {
    ...
    imagery: { column: ['p01-hero', 'p01-third', 'p01-second'], hero: 'p01-third' },
