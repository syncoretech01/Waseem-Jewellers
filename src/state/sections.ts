...
export const SECTION_LABELS: Record<SectionId, string> = {
  loader: 'The House',
  hero: 'The House of Waseem',
  craft: 'The Craft',
  heritage: 'Our House, since 1952',
  collections: 'Signature Collections',
  bridal: 'The Bridal House',
  wall: 'The Pieces',
  slider: 'The Collection',
  duality: 'Gold & Diamond',
  bespoke: 'Bespoke',
  footer: 'Visit Us',
  'collection-opening': 'The Bridal House',
  'collection-intro': 'The Bridal House',
  pieces: 'The Pieces',
  gallery: 'The Piece',
  details: 'Details',
