...
export const useSiteStore = create<SiteState>()(
  persist(
    (set, get) => ({
      ...
      // button, the ledger, the menu — unless the caller replaces it
      openConsultation: (ctx) => set({ consultation: { open: true, draft: get().consultation.draft, draftAt: get().consultation.draftAt, ...ctx } }),
