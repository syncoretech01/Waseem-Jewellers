...
export const CONCIERGE = {
  ...
  diamond: 'The Diamond Edit — bridal pieces in pavé, cluster and uncut stones. Shall I open one?',
  gold: 'The Gold Edit — bridal pieces in kundan, polki and pleated gold. Shall I open one?',
  ...
  tellAbout: (name: string, lede: string) => `The ${name}: ${lede.charAt(0).toLowerCase()}${lede.slice(1)} Weight, purity and stones are confirmed by the House at a private viewing.`,
  ...
  labels: {
    ...
    gold: 'Opening The Gold Edit…',
    goldDone: 'The Gold Edit',
    diamond: 'Opening The Diamond Edit…',
    diamondDone: 'The Diamond Edit',
