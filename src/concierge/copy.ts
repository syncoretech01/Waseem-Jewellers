...
export const CONCIERGE = {
  ...
  outOfScope: 'That is outside what we make, I am afraid. I can help with pieces, collections and private appointments.',
  watches: 'We work in gold and diamond jewellery. I can show you pieces, or arrange a private viewing at MM Alam Road.',
 ...
 */
  ...
  tellAbout: (name: string, lede: string) => `The ${name}: ${lede.charAt(0).toLowerCase()}${lede.slice(1)} Weight, purity and stones are confirmed by our jewellers at a private viewing.`,
