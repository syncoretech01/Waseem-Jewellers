...
export default async function HomePage() {
  ...
  const [showcase, departments, slugs, all] = await Promise.all([repo.showcase(), repo.departments(), repo.allSlugs(), repo.rows()]);
  ...
  return <Home showcase={showcase} departments={departments} total={slugs.length} doors={doors} />;
}
